...
const Nav = () => {
  ...
  return (
    <>
      {/* fixed background */}
      <div className={menu === true ? "bg-slate-900 opacity-30 fixed top-0 w-full  ease-in-out duration-1000  h-[100vh]" : "hidden  ease-in-out duration-1000 h-[100vh]"} onClick={() => setMenu(!menu)}>
      </div>

      <div className={!menu ? "bg-secondary  text-textcolor fixed top-0  left-[-140px] z-40    p-3 ease-in-out duration-1000 h-[100vh]  " : "bg-secondary  text-textcolor  top-0  fixed left-0  h-[100vh] w-[125px] p-3 ease-in-out duration-1000 "}>
      ...
      <>
        ...
        <div className={!menu ? "bg-secondary  text-textcolor  top-0 h-[100vh] fixed  p-3   left-0 z-0 md:w-10 w-5  ease-in-out duration-1000 " : "fixed -left-10 w-[-40px] ease-in-out duration-1000"}>
